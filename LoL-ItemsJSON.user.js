...
document.GatherTheData = function() {
	...
	if(URL.has("mobafire.com")) {
		let mobile_sr = document.querySelector("h1[class$='mobile-sr']");
		Author = mobile_sr.querySelector("a").innerHTML +" @ "+ mobile_sr.querySelector("a").href;
		ChampionName = mobile_sr.innerHTML.split("\n")[1];
		Title = document.querySelector("h2[class$='view-guide__banner__title tablet-up']").children[1].innerHTML.trim();
